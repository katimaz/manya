                                                ...
                                                <div class="col-lg-4 col-6">
                                                    ...
                                                    <div class="menu-item menu-grid-item">
                                                        ...
                                                        {{--<div class="row align-items-center mt-4">--}}
                                                            ...
                                                            {{--<div class="col-sm-6 text-sm-right mt-2 mt-sm-0"><span class="btn btn-outline-secondary btn-sm add-to-list" qty="1" product_id="{{$productMenu->product_id}}"><span>Add to list</span></span></div>--}}
                                                        {{--</div>--}}
                                                        <div class="row align-items-center mt-4">
                                                            <div class="col-sm-6"></div>
                                                            <div class="col-sm-6 text-sm-right mt-2 mt-sm-0"><span class="btn btn-outline-secondary btn-sm add-to-list" qty="1" product_id="{{$productMenu->product_id}}"><span>選取食物</span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
